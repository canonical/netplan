...
abidw _build/src/libnetplan.so.1 --headers-dir include/ --header-file src/abi.h > abi-compat/resolute_1.2.xml
```
...
```
abidiff abi-compat/resolute_1.2.xml _build/src/libnetplan.so.1 --headers-dir2 include/ --header-file2 src/abi.h --suppressions abi-compat/suppressions.abignore --no-added-syms
```
