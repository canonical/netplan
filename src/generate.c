...
int main(int argc, char** argv)
{
    ...
    //const char* generator_early_dir = NULL;
    ...
    if (called_as_generator) {
        ...
        // generator_early_dir = files[1]; //TODO: handle this
    ...
    if ((ignore_errors_env = getenv("NETPLAN_PARSER_IGNORE_ERRORS"))) {
        ...
        if (!g_strcmp0(ignore_errors_env, "1")) {
            // XXX: Can we use g_debug() inside a generator?
    ...
    // TODO: Remove this code path, it's only still supported for legacy reasons
